...
def render_city(cities):
    ...
    # 根据城市数据生成地理坐标图
    geo = Geo('《哪吒之魔童降世》粉丝位置分布', **style.init_style)
...
def handle(cities):
    # 获取坐标文件中所有地名
    data = None
    with open(r'C:\Users\Bronkape\anaconda3\envs\webCrawler\Lib\site-packages\pyecharts\datasets\city_coordinates.json', mode='r', encoding='utf-8') as f:
    ...
    # 写入覆盖坐标文件
    with open(
            r'C:\Users\Bronkape\anaconda3\envs\webCrawler\Lib\site-packages\pyecharts\datasets\city_coordinates.json',
